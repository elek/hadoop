...
import org.apache.hadoop.hdls.HdlsUtils;
...
import static org.apache.hadoop.ozone.scm.HdlsServerUtil.getDeadNodeInterval;
import static org.apache.hadoop.ozone.scm.HdlsServerUtil
    .getMaxHBToProcessPerLoop;
import static org.apache.hadoop.ozone.scm.HdlsServerUtil
    .getScmHeartbeatInterval;
import static org.apache.hadoop.ozone.scm.HdlsServerUtil
    .getScmheartbeatCheckerInterval;
import static org.apache.hadoop.ozone.scm.HdlsServerUtil.getStaleNodeInterval;
...
public class SCMNodeManager
  ...
  public SCMNodeManager(OzoneConfiguration conf, String clusterID,
    ...
    staleNodeIntervalMs = getStaleNodeInterval(conf);
    deadNodeIntervalMs = getDeadNodeInterval(conf);
    heartbeatCheckerIntervalMs =
        getScmheartbeatCheckerInterval(conf);
    datanodeHBIntervalSeconds = getScmHeartbeatInterval(conf);
    maxHBToProcessPerLoop = getMaxHBToProcessPerLoop(conf);
